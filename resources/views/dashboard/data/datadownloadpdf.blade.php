...
<div style="border: 1px solid; padding: 10px;">
    This package has been compiled at the request of {{Auth::user()->fullName('FLC')}} in accordance with the Gander Oceanic FIR Privacy Policy and the European Union GDDPR. For more information, please visit https://ganderoceanic.com/privacy.
</div>
<h5>Basic Data</h5>
<table>
