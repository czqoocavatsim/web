...
<h4 class="font-weight-bold blue-text mb-4">{{ \Carbon\Carbon::now()->format('Y') }} Top Arrival Field</h4>
    <ul class="list-unstyled">
    @php $index = 1; @endphp
        @foreach ($yearArrAirports as $tp)
            <li class="mb-1">
                    ...
                    <p class="mb-0 ml-1">
                        <span style="font-size: 1.4em;">
                                <div class="d-flex flex-column ml-2">
                                    ...
                                    <p>{{$tp->year_arr}} flight's arrived in {{ \Carbon\Carbon::now()->format('F') }}</p>
                                </div>
                        </span>
                    </p>
                </div>
