...
<html lang="en">
    ...
    <header>
        <nav id="czqoHeaderLight" class="navbar navbar-expand-md navbar-light p-0" style="min-height:59px;">
            <div class="container">
                <a class="navbar-brand" href="{{route('index')}}"><img id="czqoHeaderImg" src="{{asset('img/BannerBlue.png')}}" alt=""></a>
                    ...
                    <ul class="navbar-nav ml-auto nav-flex-icons">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-333" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="{{Auth::user()->avatar}}" style="height: 27px; width: 27px; margin-right: 3px; margin-bottom: 3px; border-radius: 50%;">&nbsp;{{Auth::user()->fullName("FLC")}}
                            </a>
