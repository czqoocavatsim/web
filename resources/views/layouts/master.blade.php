...
<html lang="en">
    ...
    <header>
        <nav id="czqoHeaderLight" class="navbar navbar-expand-lg navbar-dark blue p-0" style="min-height:59px;">
            <div class="container">
                <a class="navbar-brand" href="{{route('index')}}"><img style="height: 40px; width:auto;" id="czqoHeaderImg" src="https://resources.ganderoceanic.com/pr/brand/banner/ZQO_BANNER_BLUE.png" alt=""></a>
