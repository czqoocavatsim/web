...
<p>
    If you believe this is a mistake or have any questions, please contact us via a <a href="{{route('tickets.index')}}">support ticket</a> or email the <a href="{{route('staff')}}">OCA Chief.</a>
</p>
@endsection
