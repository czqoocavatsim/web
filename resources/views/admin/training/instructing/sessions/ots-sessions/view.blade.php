...
@section('title', 'OTS Session with ' . $session->student->user->fullName('FLC') . ' - Instructing - ')
...
<div class="d-flex flex-row align-items-center mt-3">
    ...
    <div>
        <h2 class="blue-text mt-2 mb-1 font-weight-bold">OTS Session with {{$session->student->user->fullName('F')}}</h2>
        <h5 class="fw-500">
