...
@section('content')
    <div class="card card-image rounded-0" style="background-image: url({{$article->image}}); background-size: cover; background-position: center;">
    ...
    <div class="container py-4">
        <h4 class="blue-text"><i>{{$article->summary}}</i></h4>
