    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <iframe style="border: none; margin-top: 10px; margin-bottom: 10px; width: 100%; height: 100vh;" src="https://ganderoceanic.ca/assets/resources/files/policy/CZQOP3_Privacy.pdf"></iframe>
                If the PDF is not displaying correctly, you can view it directly <a href="https://ganderoceanic.ca/assets/resources/files/policy/CZQOP3_Privacy.pdf">here.</a>
            </div>
        </div>
    </div>
</div>
